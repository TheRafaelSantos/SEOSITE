<?php
namespace BellaBeautySpace\Core;

use BellaBeautySpace\Admin\Admin;
use BellaBeautySpace\Core\Traits\Singleton;
use BellaBeautySpace\Core\Utils\File_Manager;
use BellaBeautySpace\Core\Utils\Utils;
use BellaBeautySpace\Kits\Module as Kits;
use BellaBeautySpace\Modules\Modules;
use BellaBeautySpace\TemplateFunctions\General_Elements;
use BellaBeautySpace\TemplateFunctions\Main_Elements;
use BellaBeautySpace\ThemeConfig\Theme_Config;
use BellaBeautySpace\ThemeConfig\Theme_Plugins;
...
class Core {
	...
	public function get_responsive_stylesheet_templates( $templates ) {
		...
		foreach ( $templates_paths as $template_path ) {
			$file_name = 'bella-beauty-' . basename( $template_path );
	...
	public function enqueue_frontend_assets() {
		...
		wp_localize_script( 'bella-beauty-frontend', 'cmsmasters_localize_vars', array(
	...
	public function register_widget_areas() {
		...
		register_sidebar(
			array(
				'name' => esc_html__( 'Sidebar', 'bella-beauty' ),
				'id' => 'sidebar_default',
				'description' => esc_html__( 'Widgets in this area will be shown in all left and right sidebars.', 'bella-beauty' ),
		...
		register_sidebar(
			array(
				'name' => esc_html__( 'Archive Sidebar', 'bella-beauty' ),
				'id' => 'sidebar_archive',
				'description' => esc_html__( 'Widgets in this area will be shown in all left and right sidebars on archives pages.', 'bella-beauty' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget' => '</aside>',
				'before_title' => '<h6 class="widgettitle">',
				'after_title' => '</h6>',
		...
		register_sidebar(
			array(
				'name' => esc_html__( 'Search Sidebar', 'bella-beauty' ),
				'id' => 'sidebar_search',
				'description' => esc_html__( 'Widgets in this area will be shown in all left and right sidebars on archives pages.', 'bella-beauty' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget' => '</aside>',
		...
		register_sidebar(
			array(
				'name' => esc_html__( 'Footer 1', 'bella-beauty' ),
				'id' => 'footer-1',
				'description' => esc_html__( 'Widgets in this area will be shown in footer area.', 'bella-beauty' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget' => '</aside>',
				'before_title' => '<h6 class="widgettitle">',
				'after_title' => '</h6>',
		...
		register_sidebar(
			array(
				'name' => esc_html__( 'Footer 2', 'bella-beauty' ),
				'id' => 'footer-2',
				'description' => esc_html__( 'Widgets in this area will be shown in footer area.', 'bella-beauty' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget' => '</aside>',
		...
		register_sidebar(
			array(
				'name' => esc_html__( 'Footer 3', 'bella-beauty' ),
				'id' => 'footer-3',
				'description' => esc_html__( 'Widgets in this area will be shown in footer area.', 'bella-beauty' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget' => '</aside>',
		...
		register_sidebar(
			array(
				'name' => esc_html__( 'Footer 4', 'bella-beauty' ),
				'id' => 'footer-4',
				'description' => esc_html__( 'Widgets in this area will be shown in footer area.', 'bella-beauty' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget' => '</aside>',
		...
		register_sidebar(
			array(
				'name' => esc_html__( 'Footer 5', 'bella-beauty' ),
				'id' => 'footer-5',
				'description' => esc_html__( 'Widgets in this area will be shown in footer area.', 'bella-beauty' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget' => '</aside>',
	...
	public function register_translations() {
		load_theme_textdomain( 'bella-beauty', get_template_directory() . '/theme-config/languages' );
	}
	...
	public function register_nav_menu_locations() {
		register_nav_menus(
			array(
				'header_top_nav' => esc_html__( 'Header Top Navigation', 'bella-beauty' ),
				'header_mid_nav' => esc_html__( 'Header Middle Navigation', 'bella-beauty' ),
				'header_bot_nav' => esc_html__( 'Header Bottom Navigation', 'bella-beauty' ),
				'footer_nav' => esc_html__( 'Footer Navigation', 'bella-beauty' ),
			)
		);
	}
	...
	public function filter_password_form() {
		$output = '<p>' . esc_html__( 'This content is password protected. To view it please enter your password below:', 'bella-beauty' ) . '</p>' .
		'<form action="' . esc_url( site_url( 'wp-login.php?action=postpass', 'login_post' ) ) . '" class="post-password-form cmsmasters-post-password-form" method="post">' .
			'<input name="post_password" type="password" size="20" placeholder="' . esc_attr__( 'Password', 'bella-beauty' ) . '" />' .
			'<input type="submit" name="Submit" value="' . esc_attr_x( 'Enter', 'post password form', 'bella-beauty' ) . '" />' .
		'</form>';
