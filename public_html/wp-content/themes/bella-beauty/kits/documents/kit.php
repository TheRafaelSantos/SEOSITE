<?php
namespace BellaBeautySpace\Kits\Documents;

use BellaBeautySpace\Kits\Module as KitsModule;
use BellaBeautySpace\Kits\Settings\Base\Base_Section;
...
class Kit extends BaseKit {
	...
	public function localize_settings( $settings ) {
		$settings = array_replace_recursive( $settings, array(
			'i18n' => array(
				'cmsmasters_theme' => esc_html__( 'Theme Settings', 'bella-beauty' ),
				'design_system' => esc_html__( 'Design System', 'bella-beauty' ),
				'theme_style' => esc_html__( 'Theme Style', 'bella-beauty' ),
				'settings' => esc_html__( 'Settings', 'bella-beauty' ),
				'additional_settings' => esc_html__( 'Additional Settings', 'bella-beauty' ),
			),
		) );
