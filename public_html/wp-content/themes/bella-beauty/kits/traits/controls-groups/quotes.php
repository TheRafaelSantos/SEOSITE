	...
	protected function controls_group_quotes( $key = '', $args = array() ) {
			...
			array_merge_recursive(
				...
				array(
					'fields_options' => array(
						'width' => array(
							'label' => esc_html__( 'Border Width', 'bella-beauty' ),
						),
					),
					'exclude' => array( 'color' ),
					'separator' => 'before',
		...
		$this->add_control(
			...
			array_merge_recursive(
				$default_args,
				array(
					'label' => esc_html__( 'Cite', 'bella-beauty' ),
					'type' => Controls_Manager::HEADING,
					'separator' => 'before',
				)
			)
			...
			array_merge_recursive(
				...
				array(
					...
					'options' => array(
						...
						'flex' => esc_html__( 'Show', 'bella-beauty' ),
					),
					'selectors' => array(
		...
		$this->add_responsive_control(
			...
			array_merge_recursive(
				$default_args,
				array(
					'label' => esc_html__( 'Horizontal Offset', 'bella-beauty' ),
					'type' => Controls_Manager::SLIDER,
					'size_units' => array(
						'px',
					),
		...
		$this->add_responsive_control(
			...
			array_merge_recursive(
				$default_args,
				array(
					'label' => esc_html__( 'Vertical Offset', 'bella-beauty' ),
					'type' => Controls_Manager::SLIDER,
					'size_units' => array(
						'px',
					),
