		...
		if ( $heading ) {
			$this->add_control(
				...
				array_merge_recursive(
					$default_args,
					array(
						'label' => esc_html__( 'States', 'bella-beauty' ),
		...
		foreach ( $states as $state_key => $state_label ) {
			...
			if ( 'gradient' === $background ) {
				$this->add_control(
					...
					array(
						'label' => _x( 'Background Type', 'Background Control', 'bella-beauty' ),
						'type' => Controls_Manager::CHOOSE,
						'options' => array(
							'classic' => array(
								'title' => _x( 'Classic', 'Background Control', 'bella-beauty' ),
								'icon' => 'eicon-paint-brush',
							),
							'gradient' => array(
								'title' => _x( 'Gradient', 'Background Control', 'bella-beauty' ),
								'icon' => 'eicon-barcode',
							),
						),
						'default' => 'classic',
				...
				$this->add_control(
					...
					array(
						'label' => _x( 'Background', 'Background Control', 'bella-beauty' ),
				...
				$this->add_control(
					...
					array(
						'label' => _x( 'Background Location', 'Background Control', 'bella-beauty' ),
				...
				$this->add_control(
					...
					array(
						'label' => _x( 'Second Background', 'Background Control', 'bella-beauty' ),
						'type' => Controls_Manager::COLOR,
						'dynamic' => array(),
						'render_type' => 'ui',
						'condition' => array(
				...
				$this->add_control(
					...
					array(
						'label' => _x( 'Second Background Location', 'Background Control', 'bella-beauty' ),
						'type' => Controls_Manager::SLIDER,
						'size_units' => array( '%' ),
						'default' => array(
							'unit' => '%',
				...
				$this->add_control(
					...
					array(
						'label' => _x( 'Gradient Type', 'Background Control', 'bella-beauty' ),
						'type' => Controls_Manager::SELECT,
						'options' => array(
							'linear' => _x( 'Linear', 'Background Control', 'bella-beauty' ),
							'radial' => _x( 'Radial', 'Background Control', 'bella-beauty' ),
						),
						'default' => 'linear',
						'render_type' => 'ui',
						'condition' => array(
				...
				$this->add_control(
					...
					array(
						'label' => _x( 'Gradient Angle', 'Background Control', 'bella-beauty' ),
						'type' => Controls_Manager::SLIDER,
				...
				$this->add_control(
					...
					array(
						'label' => _x( 'Gradient Position', 'Background Control', 'bella-beauty' ),
						'type' => Controls_Manager::SELECT,
						'options' => array(
							'center center' => _x( 'Center Center', 'Background Control', 'bella-beauty' ),
							'center left' => _x( 'Center Left', 'Background Control', 'bella-beauty' ),
							'center right' => _x( 'Center Right', 'Background Control', 'bella-beauty' ),
							'top center' => _x( 'Top Center', 'Background Control', 'bella-beauty' ),
							'top left' => _x( 'Top Left', 'Background Control', 'bella-beauty' ),
							'top right' => _x( 'Top Right', 'Background Control', 'bella-beauty' ),
							'bottom center' => _x( 'Bottom Center', 'Background Control', 'bella-beauty' ),
							'bottom left' => _x( 'Bottom Left', 'Background Control', 'bella-beauty' ),
							'bottom right' => _x( 'Bottom Right', 'Background Control', 'bella-beauty' ),
						),
			...
			if (
				...
				$this->add_control(
					...
					array(
						'label' => esc_html__( 'Text Decoration', 'bella-beauty' ),
						'type' => Controls_Manager::SELECT,
						'options' => array(
							'' => esc_html__( 'Default', 'bella-beauty' ),
							'none' => _x( 'None', 'Typography Control', 'bella-beauty' ),
							'underline' => _x( 'Underline', 'Typography Control', 'bella-beauty' ),
							'overline' => _x( 'Overline', 'Typography Control', 'bella-beauty' ),
							'line-through' => _x( 'Line Through', 'Typography Control', 'bella-beauty' ),
						),
						'selectors' => array(
