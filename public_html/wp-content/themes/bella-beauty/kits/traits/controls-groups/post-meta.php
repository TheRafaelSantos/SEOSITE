	...
	protected function controls_group_post_meta( $key = '', $args = array() ) {
		...
		$this->add_control(
			...
			array_merge_recursive(
				$default_args,
				array(
					'label' => esc_html__( 'Elements', 'bella-beauty' ),
					'label_block' => true,
					'description' => esc_html__( 'This setting will be applied after save and reload.', 'bella-beauty' ),
					'type' => CmsmastersControls::SELECTIZE,
					'options' => array(
						'categories' => esc_html__( 'Categories', 'bella-beauty' ),
						'author' => esc_html__( 'Author', 'bella-beauty' ),
						'date' => esc_html__( 'Date', 'bella-beauty' ),
						'comments' => esc_html__( 'Comments', 'bella-beauty' ),
						'tags' => esc_html__( 'Tags', 'bella-beauty' ),
					),
					'multiple' => true,
		...
		$color_controls = array(
			'colors_text' => esc_html__( 'Text', 'bella-beauty' ),
			'colors_link' => esc_html__( 'Link', 'bella-beauty' ),
			'colors_hover' => esc_html__( 'Link Hover', 'bella-beauty' ),
		);
		...
		$this->add_control(
			...
			array_merge_recursive(
				...
				array(
					...
					'options' => array(
						'none' => esc_html__( 'Hide', 'bella-beauty' ),
						'block' => esc_html__( 'Show', 'bella-beauty' ),
					),
					'selectors' => array(
