<?php
namespace BellaBeautySpace\Kits\Classes;

use BellaBeautySpace\Kits\Documents\Kit;
...
class Kit_Globals {
	...
	public static function get_global_colors_defaults() {
		return array(
			array(
				'_id' => 'primary',
				'title' => esc_html__( 'Primary', 'bella-beauty' ),
				'color' => Theme_Config::PRIMARY_COLOR_DEFAULT,
			),
			array(
				'_id' => 'secondary',
				'title' => esc_html__( 'Secondary', 'bella-beauty' ),
				'color' => Theme_Config::SECONDARY_COLOR_DEFAULT,
			),
			array(
				'_id' => 'text',
				'title' => esc_html__( 'Text', 'bella-beauty' ),
				'color' => Theme_Config::TEXT_COLOR_DEFAULT,
			),
			array(
				'_id' => 'accent',
				'title' => esc_html__( 'Accent', 'bella-beauty' ),
				'color' => Theme_Config::ACCENT_COLOR_DEFAULT,
			),
			array(
				'_id' => 'tertiary',
				'title' => esc_html__( 'Alternate Accent', 'bella-beauty' ),
				'color' => Theme_Config::TERTIARY_COLOR_DEFAULT,
			),
			array(
				'_id' => 'background',
				'title' => esc_html__( 'Background', 'bella-beauty' ),
				'color' => Theme_Config::BACKGROUND_COLOR_DEFAULT,
			),
			array(
				'_id' => 'alternate',
				'title' => esc_html__( 'Alternate Background', 'bella-beauty' ),
				'color' => Theme_Config::ALTERNATE_COLOR_DEFAULT,
			),
			array(
				'_id' => 'border',
				'title' => esc_html__( 'Border', 'bella-beauty' ),
	...
	public static function get_global_typography_defaults() {
		...
		return array(
			...
			array(
				'_id' => 'meta',
				'title' => esc_html__( 'Meta', 'bella-beauty' ),
				$typography_key => 'custom',
			...
			array(
				'_id' => 'taxonomy',
				'title' => esc_html__( 'Alternate Meta', 'bella-beauty' ),
				$typography_key => 'custom',
			...
			array(
				'_id' => 'small',
				'title' => esc_html__( 'Small', 'bella-beauty' ),
				$typography_key => 'custom',
			...
			array(
				'_id' => 'h1',
				'title' => esc_html__( 'H1', 'bella-beauty' ),
				$typography_key => 'custom',
			...
			array(
				'_id' => 'h2',
				'title' => esc_html__( 'H2', 'bella-beauty' ),
				$typography_key => 'custom',
			...
			array(
				'_id' => 'h3',
				'title' => esc_html__( 'H3', 'bella-beauty' ),
				$typography_key => 'custom',
			...
			array(
				'_id' => 'h4',
				'title' => esc_html__( 'H4', 'bella-beauty' ),
				$typography_key => 'custom',
			...
			array(
				'_id' => 'h5',
				'title' => esc_html__( 'H5', 'bella-beauty' ),
				$typography_key => 'custom',
			...
			array(
				'_id' => 'h6',
				'title' => esc_html__( 'H6', 'bella-beauty' ),
				$typography_key => 'custom',
			...
			array(
				'_id' => 'button',
				'title' => esc_html__( 'Button', 'bella-beauty' ),
				$typography_key => 'custom',
			...
			array(
				'_id' => 'blockquote',
				'title' => esc_html__( 'Blockquote', 'bella-beauty' ),
				$typography_key => 'custom',
