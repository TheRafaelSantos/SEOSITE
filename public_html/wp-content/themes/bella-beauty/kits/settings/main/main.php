<?php
namespace BellaBeautySpace\Kits\Settings\Main;
...
class Main extends Settings_Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'Main', 'bella-beauty' );
	}
	...
	protected function register_toggle_controls() {
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Content', 'bella-beauty' ),
		...
		$this->add_responsive_control(
			...
			array(
				...
				'description' => esc_html__( 'This value will be used for page layouts with sidebar.', 'bella-beauty' ) . '<br />' . esc_html__( 'The width of the sidebar will be equal "100% - this value".', 'bella-beauty' ) . '<br />' . esc_html__( 'For example: 74% - content width, then sidebar width will be 26%.', 'bella-beauty' ) . '<br />' . esc_html__( 'Default value is 74%.', 'bella-beauty' ),
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Sidebar', 'bella-beauty' ),
				'type' => Controls_Manager::HEADING,
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'description' => esc_html__( 'Gap between content and sidebar.', 'bella-beauty' ) . '<br />' . esc_html__( 'Default value is 40px.', 'bella-beauty' ) . '<br />' . esc_html__( 'Note: This gap reduces the width of the sidebar.', 'bella-beauty' ),
				'type' => Controls_Manager::SLIDER,
				'range' => array(
					'px' => array(
						'min' => 0,
		...
		$this->add_control(
			...
			array(
				'label' => _x( 'Divider Type', 'Divider Control', 'bella-beauty' ),
				'type' => Controls_Manager::SELECT,
				'options' => array(
					'' => _x( 'Default', 'Divider Control', 'bella-beauty' ),
					'none' => _x( 'None', 'Divider Control', 'bella-beauty' ),
					'solid' => _x( 'Solid', 'Divider Control', 'bella-beauty' ),
					'double' => _x( 'Double', 'Divider Control', 'bella-beauty' ),
					'dotted' => _x( 'Dotted', 'Divider Control', 'bella-beauty' ),
					'dashed' => _x( 'Dashed', 'Divider Control', 'bella-beauty' ),
					'groove' => _x( 'Groove', 'Divider Control', 'bella-beauty' ),
				),
				'selectors' => array(
		...
		$this->add_responsive_control(
			...
			array(
				'label' => _x( 'Width', 'Divider Control', 'bella-beauty' ),
				'type' => Controls_Manager::SLIDER,
				'range' => array(
					'px' => array(
						'min' => 0,
		...
		$this->add_control(
			...
			array(
				'label' => _x( 'Color', 'Divider Control', 'bella-beauty' ),
