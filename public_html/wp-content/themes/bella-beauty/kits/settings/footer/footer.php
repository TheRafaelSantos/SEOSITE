...
class Footer extends Settings_Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'Footer', 'bella-beauty' );
	}
	...
	protected function register_toggle_controls() {
		$this->add_control(
			'notice',
			array(
				'raw' => esc_html__( "If you use a 'Footer' template, then the settings will not be applied, if you set the template to sitewide, then these settings will be hidden.", 'bella-beauty' ),
		...
		$this->add_control(
			'alignment',
			array(
				'label' => esc_html__( 'Alignment', 'bella-beauty' ),
				'label_block' => false,
				'type' => Controls_Manager::CHOOSE,
				'options' => array(
					'center' => array(
					...
					'space-between' => array(
						'title' => esc_html__( 'Justified', 'bella-beauty' ),
