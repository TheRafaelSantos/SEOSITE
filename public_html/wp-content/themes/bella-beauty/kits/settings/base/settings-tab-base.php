<?php
namespace BellaBeautySpace\Kits\Settings\Base;

use BellaBeautySpace\Kits\Traits\Base as KitBaseTraits;
...
abstract class Settings_Tab_Base extends Tab_Base {
	...
	public function get_default_setting( $key, $default = false ) {
		$settings = get_option( 'cmsmasters_bella-beauty_default_kits', array() );
