...
class Table extends Settings_Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'Table', 'bella-beauty' );
	}
	...
	protected function register_toggle_controls() {
		$this->add_control(
			'notice',
			array(
				'raw' => esc_html__( 'Used in: default table, Gutenberg editor.', 'bella-beauty' ),
		...
		$parts = array(
			'tbody' => '',
			'thead' => esc_html__( 'Header', 'bella-beauty' ),
			'tfoot' => esc_html__( 'Footer', 'bella-beauty' ),
		);
