...
class Slider_Arrows extends Settings_Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'Slider Arrows', 'bella-beauty' );
	}
	...
	protected function register_toggle_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'options' => array(
					'always' => esc_html__( 'Always', 'bella-beauty' ),
					'hover' => esc_html__( 'On Hover', 'bella-beauty' ),
				),
				'toggle' => false,
		...
		foreach ( array(
			'prev' => esc_html__( 'Previous', 'bella-beauty' ),
			'next' => esc_html__( 'Next', 'bella-beauty' ),
		) as $key => $label ) {
			$is_prev = 'prev' === $key;
			...
			$this->add_control(
				"{$key}_icon_position",
				array(
					'label' => esc_html__( 'Icon Position', 'bella-beauty' ),
					'description' => esc_html__( 'This setting will be applied after save and reload.', 'bella-beauty' ),
					'type' => Controls_Manager::SELECT,
					'options' => array(
						'before' => esc_html__( 'Before', 'bella-beauty' ),
						'after' => esc_html__( 'After', 'bella-beauty' ),
					),
					'default' => $this->get_default_setting(
		...
		$this->add_control(
			'text_direction',
			array(
				'label' => esc_html__( 'Text Direction', 'bella-beauty' ),
				'description' => esc_html__( 'This setting will be applied after save and reload.', 'bella-beauty' ),
				'type' => Controls_Manager::SELECT,
				'options' => array(
					'horizontal' => esc_html__( 'Horizontal', 'bella-beauty' ),
					'vertical' => esc_html__( 'Vertical', 'bella-beauty' ),
				),
				'default' => $this->get_default_setting(
		...
		$this->add_responsive_control(
			'icon_size',
			array(
				'label' => esc_html__( 'Icon Size', 'bella-beauty' ),
				'type' => Controls_Manager::SLIDER,
		...
		$this->add_responsive_control(
			'spacing',
			array(
				'label' => esc_html__( 'Arrows Spacing', 'bella-beauty' ),
				'type' => Controls_Manager::SLIDER,
				'range' => array(
					'px' => array(
						'min' => 0,
		...
		$this->add_responsive_control(
			'box_width',
			array(
				'label' => esc_html__( 'Arrows Box Width', 'bella-beauty' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => array( 'px', '%' ),
				'range' => array(
					'%' => array(
		...
		$this->add_responsive_control(
			'box_height',
			array(
				'label' => esc_html__( 'Arrows Box Height', 'bella-beauty' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => array( 'px', '%' ),
				'range' => array(
					'%' => array(
		...
		$this->add_responsive_control(
			'icon_gap',
			array(
				'label' => esc_html__( 'Icon Gap', 'bella-beauty' ),
				'description' => esc_html__( 'Gap Between Icon and Text', 'bella-beauty' ),
				'type' => Controls_Manager::SLIDER,
				'range' => array(
					'px' => array(
						'max' => 50,
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Text On Tablet/Mobile', 'bella-beauty' ),
				'label_block' => false,
				'type' => CmsmastersControls::CHOOSE_TEXT,
				'options' => array(
					'flex' => array(
						'title' => esc_html__( 'Show', 'bella-beauty' ),
					),
					'none' => array(
						'title' => esc_html__( 'Hide', 'bella-beauty' ),
					),
				),
				'toggle' => true,
				'selectors' => array(
		...
		$this->add_control(
			...
			array(
				...
				'options' => array(
					'row' => array(
						'title' => esc_html__( 'Horizontal', 'bella-beauty' ),
						'icon' => 'eicon-navigation-horizontal',
					),
					'column' => array(
						'title' => esc_html__( 'Vertical', 'bella-beauty' ),
		...
		$this->add_responsive_control(
			...
			array(
				...
				'options' => array(
					...
					'space-between' => array(
						'title' => esc_html__( 'Space Between', 'bella-beauty' ),
		...
		$this->add_responsive_control(
			...
			array(
				...
				'options' => array(
					...
					'center' => array(
						'title' => esc_html__( 'Middle', 'bella-beauty' ),
