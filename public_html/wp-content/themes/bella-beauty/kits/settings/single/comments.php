...
class Comments extends Settings_Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'Comments', 'bella-beauty' );
	}
	...
	protected function register_toggle_controls() {
		$this->add_responsive_control(
			'items_vert_gap',
			array(
				'label' => esc_html__( 'Items Vertical Gap Between', 'bella-beauty' ),
		...
		$this->add_responsive_control(
			'items_hor_gap',
			array(
				'label' => esc_html__( 'Child Items Horizontal Gap', 'bella-beauty' ),
				'type' => Controls_Manager::SLIDER,
				'range' => array(
					'px' => array(
						'min' => 0,
