...
class More_Posts extends Settings_Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'More Posts', 'bella-beauty' );
	}
	...
	protected function register_toggle_controls() {
		$this->add_control(
			...
			array(
				...
				'placeholder' => esc_html__( 'More Posts', 'bella-beauty' ),
			)
		);
		...
		$this->add_control(
			...
			array(
				'raw' => esc_html__( 'This setting will be applied after save and reload', 'bella-beauty' ),
		...
		$this->add_control(
			'more_posts_order',
			array(
				'label' => esc_html__( 'Order by', 'bella-beauty' ),
				'label_block' => false,
				'description' => esc_html__( 'This setting will be applied after save and reload.', 'bella-beauty' ),
				'type' => Controls_Manager::SELECT,
				'options' => array(
					'recent' => esc_html__( 'Recent', 'bella-beauty' ),
					'category' => esc_html__( 'Related by Categories', 'bella-beauty' ),
					'post_tag' => esc_html__( 'Related by Tags', 'bella-beauty' ),
				),
				'default' => $this->get_default_setting(
		...
		$this->add_control(
			'more_posts_count',
			array(
				'label' => esc_html__( 'Count', 'bella-beauty' ),
				'description' => esc_html__( 'This setting will be applied after save and reload.', 'bella-beauty' ),
