...
class Nav extends Settings_Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'Posts Navigation', 'bella-beauty' );
	}
	...
	protected function register_toggle_controls() {
		$this->add_control(
			'nav_tax',
			array(
				'label' => esc_html__( 'Order by Taxonomy', 'bella-beauty' ),
				'label_block' => false,
				...
				'options' => array(
					...
					'category' => esc_html__( 'Category', 'bella-beauty' ),
					'post_tag' => esc_html__( 'Tag', 'bella-beauty' ),
				),
		...
		$this->add_control(
			'nav_text_above_prev',
			array(
				'label' => esc_html__( 'Text Above Previous Post Title', 'bella-beauty' ),
				'label_block' => true,
				'description' => esc_html__( 'This setting will be applied after save and reload.', 'bella-beauty' ),
				'type' => Controls_Manager::TEXT,
				'placeholder' => esc_html__( 'Previous', 'bella-beauty' ),
			)
		);
		...
		$this->add_control(
			'nav_text_above_next',
			array(
				'label' => esc_html__( 'Text Above Next Post Title', 'bella-beauty' ),
				'label_block' => true,
				'description' => esc_html__( 'This setting will be applied after save and reload.', 'bella-beauty' ),
				'type' => Controls_Manager::TEXT,
				'placeholder' => esc_html__( 'Next', 'bella-beauty' ),
			)
		);
