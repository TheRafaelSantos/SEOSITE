<?php
namespace BellaBeautySpace\Kits\Settings\HeaderMid;
...
class Header_Mid extends Settings_Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'Header Middle', 'bella-beauty' );
	}
	...
	protected function register_toggle_controls() {
		$this->add_control(
			'notice',
			array(
				'raw' => esc_html__( "If you use a 'Header' template, then the settings will not be applied, if you set the template to sitewide, then these settings will be hidden.", 'bella-beauty' ),
		...
		$this->add_control(
			...
			array(
				...
				'options' => array(
					'wide' => array(
						'title' => esc_html__( 'Wide', 'bella-beauty' ),
					),
					'centered' => array(
						'title' => esc_html__( 'Centered', 'bella-beauty' ),
					),
				),
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Content Element', 'bella-beauty' ),
		...
		$this->add_control(
			...
			array(
				...
				'options' => array(
					...
					'info' => esc_html__( 'Short Info', 'bella-beauty' ),
					'html' => esc_html__( 'Custom HTML', 'bella-beauty' ),
					'nav' => esc_html__( 'Navigation', 'bella-beauty' ),
				),
				'default' => $this->get_default_setting(
		...
		$this->add_responsive_control(
			...
			array(
				...
				'description' => esc_html__( 'Gap between content and additional content', 'bella-beauty' ),
				'type' => Controls_Manager::SLIDER,
				'range' => array(
					'px' => array(
						'min' => -10,
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Additional Content Elements Order', 'bella-beauty' ),
				'type' => Controls_Manager::HEADING,
				'condition' => array(
					$this->get_control_id_parameter( '', 'type' ) => 'wide',
				),
		...
		$this->add_control(
			...
			array(
				...
				'options' => array(
					'social' => esc_html__( 'Social Icons', 'bella-beauty' ),
					'button' => esc_html__( 'Button', 'bella-beauty' ),
					'search_button' => esc_html__( 'Search Button', 'bella-beauty' ),
				),
				'multiple' => true,
				'default' => $this->get_default_setting(
		...
		$this->add_responsive_control(
			...
			array(
				'label' => esc_html__( 'Gap Between', 'bella-beauty' ),
				'description' => esc_html__( 'Gap between additional content items', 'bella-beauty' ),
				'type' => Controls_Manager::SLIDER,
				'range' => array(
					'px' => array(
						'min' => -10,
		...
		$this->add_responsive_control(
			'z_index',
			array(
				'label' => esc_html__( 'Z-Index', 'bella-beauty' ),
