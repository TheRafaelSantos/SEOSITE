...
class Woo_Product_Filter {
	...
	public static function get_import_status( $default = 'done' ) {
		return get_option( 'cmsmasters_bella-beauty_' . Utils::get_demo() . '_woo_product_filter_import', $default );
	}
	...
	public static function set_import_status( $status = 'pending' ) {
		...
		update_option( 'cmsmasters_bella-beauty_' . Utils::get_demo() . '_woo_product_filter_import', $status );
	}
