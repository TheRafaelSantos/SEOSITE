...
class Give_WP {
	...
	public static function get_import_status( $default = 'done' ) {
		return get_option( 'cmsmasters_bella-beauty_' . Utils::get_demo() . '_givewp_import', $default );
	}
	...
	public static function set_import_status( $status = 'pending' ) {
		...
		update_option( 'cmsmasters_bella-beauty_' . Utils::get_demo() . '_givewp_import', $status );
	}
	...
	protected function set_exists_options() {
		$this->options = get_option( 'cmsmasters_bella-beauty_' . Utils::get_demo() . '_givewp', array() );
	}
	...
	public static function set_backup_options( $first_install = false ) {
		...
		$option_name = 'cmsmasters_bella-beauty_' . Utils::get_demo() . '_givewp';

		if ( $first_install ) {
			$option_name = 'cmsmasters_bella-beauty_givewp_backup';
		}
