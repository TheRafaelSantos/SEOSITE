...
use BellaBeautySpace\Admin\Installer\Importer\Elementor_Attachments;
use BellaBeautySpace\Admin\Installer\Importer\Elementor_Templates;
use BellaBeautySpace\Admin\Installer\Importer\Elementor_Widgets;
...
class Elementor_Importer {
	...
	public function end_import() {
		...
		update_option( "cmsmasters_bella-beauty_{$demo}_content_import_status", 'imported', false );
	}
	...
	protected function change_import_elements_ids() {
		...
		$displayed_ids = get_option( "cmsmasters_bella-beauty_{$demo}_import_displayed_ids" );
		$forminator_forms_ids = get_option( "cmsmasters_bella-beauty_{$demo}_forminator_import_forms_ids" );
		$wpforms_forms_ids = get_option( "cmsmasters_bella-beauty_{$demo}_wpforms_import_forms_ids" );
