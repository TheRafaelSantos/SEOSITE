...
use BellaBeautySpace\Admin\Installer\Importer\ACF;
use BellaBeautySpace\Admin\Installer\Importer\CPTUI;
use BellaBeautySpace\Admin\Installer\Importer\Elementor_Fonts;
use BellaBeautySpace\Admin\Installer\Importer\Elementor_Icons;
use BellaBeautySpace\Admin\Installer\Importer\Elementor_Importer;
use BellaBeautySpace\Admin\Installer\Importer\Elementor_Kit;
use BellaBeautySpace\Admin\Installer\Importer\Elementor_Templates;
use BellaBeautySpace\Admin\Installer\Importer\Theme_Options;
use BellaBeautySpace\Admin\Installer\Importer\WPForms;
use BellaBeautySpace\Admin\Installer\Importer\Forminator;
use BellaBeautySpace\Admin\Installer\Importer\Give_WP;
use BellaBeautySpace\Admin\Installer\Importer\WPRM_Templates;
use BellaBeautySpace\Admin\Installer\Importer\Woo_Product_Filter;
use BellaBeautySpace\Admin\Installer\Importer\Revslider;
use BellaBeautySpace\Admin\Installer\Importer\WPClever_Smart_Compare;
use BellaBeautySpace\Admin\Installer\Importer\WPClever_Smart_Quick_View;
use BellaBeautySpace\Admin\Installer\Importer\WPClever_Smart_Wishlist;
use BellaBeautySpace\Admin\Installer\Importer\WPClever_Variation_Swatches;
...
class Importer {
	...
	public function set_import_attachments_ids( $post_id, $original_id, $postdata, $data ) {
		...
		$attachments_ids = get_option( "cmsmasters_bella-beauty_{$demo}_import_attachments_ids" );
		...
		update_option( "cmsmasters_bella-beauty_{$demo}_import_attachments_ids", $attachments_ids, false );
	}
	...
	public function set_import_posts_ids( $post_id, $original_id, $postdata, $post ) {
		...
		$displayed_ids = get_option( "cmsmasters_bella-beauty_{$demo}_import_displayed_ids" );
		...
		update_option( "cmsmasters_bella-beauty_{$demo}_import_displayed_ids", $displayed_ids, false );
	}
	...
	public function remove_import_temp_options() {
		...
		if ( 'imported' !== get_option( "cmsmasters_bella-beauty_{$demo}_content_import_status" ) ) {
			return;
		}

		delete_option( "cmsmasters_bella-beauty_{$demo}_elementor_import_templates_ids" );
		delete_option( "cmsmasters_bella-beauty_{$demo}_forminator_import_forms_ids" );
		delete_option( "cmsmasters_bella-beauty_{$demo}_import_attachments_ids" );
		delete_option( "cmsmasters_bella-beauty_{$demo}_import_displayed_ids" );
		delete_option( "cmsmasters_bella-beauty_{$demo}_wpforms_import_forms_ids" );
	}
