...
class Elementor_Icons {
	...
	public static function set_import_status( $status = 'pending' ) {
		...
		if ( 'done' === get_option( "cmsmasters_bella-beauty_{$demo}_elementor_icons_import" ) ) {
			return;
		}

		update_option( "cmsmasters_bella-beauty_{$demo}_elementor_icons_import", $status );
	}
	...
	public function get_local_icons() {
		...
		if ( 'pending' !== get_option( "cmsmasters_bella-beauty_{$demo}_elementor_icons_import", 'done' ) ) {
			return;
		}
		...
		update_option( "cmsmasters_bella-beauty_{$demo}_elementor_icons_import", 'done' );
	}
