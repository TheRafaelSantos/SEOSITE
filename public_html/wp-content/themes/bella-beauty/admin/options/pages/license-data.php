...
class License_Data extends Base\Base_Page {
	...
	public static function get_page_title() {
		return esc_attr__( 'License Data', 'bella-beauty' );
	}
	...
	public function render_content() {
		...
		echo '<div class="cmsmasters-options-license-data">';
			...
			echo '<h3 class="cmsmasters-options-license-data__title">' . esc_html__( 'License Data', 'bella-beauty' ) . '</h3>';
			...
			echo '<div class="cmsmasters-options-license-data__user-info">
				...
				<div class="cmsmasters-options-license-data__user-info--item">
					<input type="text" name="cmsmasters_options_license_data__user_name" placeholder="' . esc_attr__( 'Your Name', 'bella-beauty' ) . '" value="' . esc_attr( $user_name ) . '" />
				</div>
				<div class="cmsmasters-options-license-data__user-info--item">
					<input type="text" name="cmsmasters_options_license_data__user_email" placeholder="' . esc_attr__( 'Your Email', 'bella-beauty' ) . '" value="' . esc_attr( $user_email ) . '" />
				</div>
			...
			echo '<div class="cmsmasters-options-license-data__button-wrap">
				<button type="button" class="button cmsmasters-button-spinner" data-action="update-license-data">' . esc_html__( 'Update', 'bella-beauty' ) . '</button>
	...
	public function ajax_update_license_data() {
		if ( ! check_ajax_referer( 'cmsmasters_options_nonce', 'nonce' ) ) {
			wp_send_json( array(
				'success' => false,
				'code' => 'invalid_nonce',
				'message' => esc_html__( 'Yikes! Data update failed. Please try again.', 'bella-beauty' ),
			) );
		}
		...
		$data = API_Requests::post_request( 'update-client-data', array(
			...
			'token' => get_option( 'cmsmasters_bella-beauty_token', 'invalid' ),
		) );
