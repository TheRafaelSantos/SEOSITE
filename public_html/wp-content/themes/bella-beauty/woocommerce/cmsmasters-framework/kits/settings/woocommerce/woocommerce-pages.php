<?php
namespace BellaBeautySpace\Woocommerce\CmsmastersFramework\Kits\Settings\Woocommerce;
...
class Woocommerce_Pages extends Settings_Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'WooCommerce Pages', 'bella-beauty' );
	}
	...
	protected function register_toggle_controls() {
		$this->add_control(
			...
			array(
				'raw' => esc_html__( 'Select the pages you want to use as your default WooCommerce shop pages', 'bella-beauty' ),
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Cart', 'bella-beauty' ),
				'type' => CmsmastersControls::QUERY,
				'select2options' => array(
					'placeholder' => esc_html__( 'Select a page', 'bella-beauty' ),
				),
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Checkout', 'bella-beauty' ),
				'type' => CmsmastersControls::QUERY,
				'select2options' => array(
					'placeholder' => esc_html__( 'Select a page', 'bella-beauty' ),
				),
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'My Account', 'bella-beauty' ),
				'type' => CmsmastersControls::QUERY,
				'select2options' => array(
					'placeholder' => esc_html__( 'Select a page', 'bella-beauty' ),
				),
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Terms & Conditions', 'bella-beauty' ),
				'type' => CmsmastersControls::QUERY,
				'select2options' => array(
					'placeholder' => esc_html__( 'Select a page', 'bella-beauty' ),
				),
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Purchase Summary', 'bella-beauty' ),
				'type' => CmsmastersControls::QUERY,
				'select2options' => array(
					'placeholder' => esc_html__( 'Select a page', 'bella-beauty' ),
				),
		...
		$this->add_control(
			...
			array(
				'type' => Controls_Manager::RAW_HTML,
				'raw' => esc_html__( 'Note: Changes you make here will also be reflected in the WooCommerce settings on your WP dashboard', 'bella-beauty' ),
