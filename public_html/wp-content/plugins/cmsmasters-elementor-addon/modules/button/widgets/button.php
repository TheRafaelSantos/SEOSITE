	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'options' => array(
					...
					'none' => __( 'None', 'cmsmasters-elementor', 'cmsmasters-elementor' ),
					'underline' => __( 'Underline', 'cmsmasters-elementor', 'cmsmasters-elementor' ),
					'overline' => __( 'Overline', 'cmsmasters-elementor', 'cmsmasters-elementor' ),
					'line-through' => __( 'Line Through', 'cmsmasters-elementor', 'cmsmasters-elementor' ),
				),
				'selectors' => array(
		...
		$this->add_group_control(
			...
			array(
				...
				'fields_options' => array(
					'border' => array(
						'options' => array(
							'' => __( 'Default', 'cmsmasters-elementor', 'cmsmasters-elementor' ),
							'none' => __( 'None', 'cmsmasters-elementor', 'cmsmasters-elementor' ),
							'solid' => __( 'Solid', 'cmsmasters-elementor', 'cmsmasters-elementor' ),
							'double' => __( 'Double', 'cmsmasters-elementor', 'cmsmasters-elementor' ),
							'dotted' => __( 'Dotted', 'cmsmasters-elementor', 'cmsmasters-elementor' ),
							'dashed' => __( 'Dashed', 'cmsmasters-elementor', 'cmsmasters-elementor' ),
							'groove' => __( 'Groove', 'cmsmasters-elementor', 'cmsmasters-elementor' ),
						),
						'default' => '',
					),
					'width' => array(
						'label' => __( 'Border Width', 'cmsmasters-elementor', 'cmsmasters-elementor' ),
						'condition' => array(
							'border!' => array(
								'',
								'none',
		...
		$this->add_group_control(
			...
			array(
				...
				'fields_options' => array(
					'color' => array(
						'label' => __( 'Border Color', 'cmsmasters-elementor', 'cmsmasters-elementor' ),
					),
				),
