		...
		if ( ! $wp_query->found_posts ) {
			if ( $this->is_current_query() ) {
				echo '<h4 class="cmsmasters-blog__nothing-found">' .
					( ! empty( $this->get_settings_fallback( 'nothing_found_message' ) ) ? $this->get_settings_fallback( 'nothing_found_message' ) : esc_html__( 'Posts not found!', 'cmsmasters-elementor' ) ) .
				'</h4>';
			} else {
